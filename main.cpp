...
int temperature[50]; 
	...
	pos = 0;
	cout << "Please input a temperature from 1 to 100, (or -99 to stop)" << endl;
	cin >> temperature[pos];

	while (temperature[pos] != -99)
	{
		pos++;
		cout << "Please input a temperature from 1 to 100, (or -99 to stop)" << endl;
		cin >> temperature[pos];
	...
	cout << endl << "The average of all the temperatures is " << avgOfTemperature << endl;
